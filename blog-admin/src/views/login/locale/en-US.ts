export default {
  ...
  'login.form.userName.errMsg': 'LoginName cannot be empty',
  'login.form.password.errMsg': 'Password cannot be empty',
  'login.form.login.errMsg': 'Login error, refresh and try again',
  'login.form.login.success': 'welcome to use',
  'login.form.userName.placeholder': 'Please fill in LoginName',
  'login.form.password.placeholder': 'Please fill in Password',
